function lighting_global() {
	...
	global.FilmGrainSpeed = 0;
	global.FilmGrainStrength = 32;
...
#macro __LIGHT_SHADER SHD_BlendLight

	// The shader used to draw the world shadow map
#macro __WORLD_SHADOW_MAP_SHADER SHD_ShadowMap

	// The object that is responsible for rendering the lighting system
#macro __LIGHT_RENDERER SYS_LightRender
	...
	global.u_FilmGrainSpeed = shader_get_uniform(__WORLD_SHADOW_MAP_SHADER, "u_FilmGrainSpeed");
	
	global.u_FilmGrainStrength = shader_get_uniform(__WORLD_SHADOW_MAP_SHADER, "u_FilmGrainStrength");
